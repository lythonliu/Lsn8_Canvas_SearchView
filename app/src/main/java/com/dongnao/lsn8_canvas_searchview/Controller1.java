...
//			canvas.drawArc(r, 0, 90, true, paint);//顺时针旋转90度
            ...
            //绘制把手
            canvas.drawLine(
                    mRectF.right - mDeltaD + mRadius *(aFloat *2-1),
                    mRectF.bottom - mDeltaD + mRadius *(aFloat *2-1),
        ...
        //绘制下面的横线
        canvas.drawLine(
                (mRectF.right - mDeltaD + mRadius)*(1- aFloat *0.8f),
                mRectF.bottom+ mRadius - mDeltaD,
                mRectF.right - mDeltaD + mRadius,
                mRectF.bottom+ mRadius - mDeltaD,
                paint);
        ...
        mRectF.left = mCircleX - mRadius + aFloat *250;
        mRectF.right = mCircleX + mRadius + aFloat *250;
